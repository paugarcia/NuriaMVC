...
/**
 * Este es el Controlador de la ventana de Política de condiciones
 *
 * @author Pau Garcia
 */
class PoliticaController extends ControllerBase {
    //put your code here
    protected $model;
    protected $view;
    private $conf;
    ...
    public function __construct($arr) {
       ...
       //carregar la configuració
        ...
        $this->model= new PoliticaModel($arr);
        $this->view=new View();       
    }
     public function index(){
        ...
        $this->view->setTemplate(APP.'/public/tpl/Politica.php');
        $this->view->render();        
    }
}
