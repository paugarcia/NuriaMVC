...
/**
 * Este es el Controlador de la ventana de Parques de Atracciones
 *
 * @author Pau Garcia
 */
class ParcsController extends ControllerBase{
    //put your code here
    protected $model;
    protected $view;
    private $conf;
    ...
    public function __construct($arr) {
     ...
     public function index(){
        ...
        $this->view->setTemplate(APP.'/public/tpl/parcs.php');
        $this->view->render();       
    }
    /**
     * Funcio per a realitzar una reserva de tipus parc de atraccions
     */
